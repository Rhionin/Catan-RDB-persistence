...
var RDBCommandStore = (function() {
	...
	*/
	...
	RDBCommandStore.prototype.getCommandsSinceCommand = function(gameId, commandId, callback)
	{

		this.rdb.all("SELECT * from Commands WHERE id > " + commandId + " AND gameid = " + gameId, function(response){
